...
pub struct ShaderLightingPass {
    ...
    pub uniform_image_depth: Option<WebGlUniformLocation>,
}
...
impl ShaderLightingPass {
    pub fn new(
        ...
        let uniform_image_depth = gl.get_uniform_location(&program, "image_depth");
    ...
    pub fn setup(
        ...
        image_depth: &Option<WebGlTexture>,
    ) {
