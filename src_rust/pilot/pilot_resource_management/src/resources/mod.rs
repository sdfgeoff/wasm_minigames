...
pub struct Meshes {
    ...
    pub other_assets_landing_lights: crate::geometry::Geometry,
...
impl Meshes {
    fn new(gl: &web_sys::WebGl2RenderingContext) -> Result<Self, crate::geometry::GeometryError> {
        Ok(Self {
            ...
            other_assets_landing_lights: crate::mesh::load_mesh(gl, include_bytes!("raw/other_assets_landing_lights.mesh"))?,
