...
impl Textures {
    pub fn load(gl: &Context) -> Result<Self, TextureError> {
        Ok(Self {
            ...
            test_tex: Texture::load_from_png(gl, include_bytes!("test_tex.png"), TextureConfig::default())?,
            cloud_map: Texture::load_from_png(gl, include_bytes!("cloud_map.png"), TextureConfig::default())?,
        })
    }
}
